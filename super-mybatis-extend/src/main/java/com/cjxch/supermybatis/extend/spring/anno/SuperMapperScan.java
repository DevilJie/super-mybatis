 ...
 * {@link MapperScannerConfigurer} via {@link SuperMapperScannerRegistrar}.
 * 
 * <p>
 ...
 *
 * @since 1.2.0
 * @see SuperMapperScannerRegistrar
 * @see MapperFactoryBean
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
@Documented
@Import(SuperMapperScannerRegistrar.class)
@Repeatable(SuperMapperScans.class)
