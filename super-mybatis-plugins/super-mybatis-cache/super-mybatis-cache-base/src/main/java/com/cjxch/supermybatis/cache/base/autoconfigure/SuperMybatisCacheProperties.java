...
/**
 * 自定义MybatisProperties，在MybatisProperties基础上，新增了globalSetting的配置信息
 * 可以在yml文件中对全局参数进行配置
...
public class SuperMybatisCacheProperties {
  ...
  @NestedConfigurationProperty
  private CacheGlobalSetting globalSetting = null;
  ...
  public CacheGlobalSetting getGlobalSetting() {
    return globalSetting;
  }

  public void setGlobalSetting(CacheGlobalSetting globalSetting) {
